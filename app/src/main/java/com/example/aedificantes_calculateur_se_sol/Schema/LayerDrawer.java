...
public class LayerDrawer {
    ...
    public LayerDrawer(ArrayList<ParamSolData> listParamSolData,PieuManagerData pieuParamManagerData) {
    ...
    public void toDraw(Canvas canvas, float offset_x_prop, float size_X_prop, float offset_y_prop, WindowManager manager){
